...
export default function EndFooter({profile}: {profile: GetProfileQuery["profile"]}) {
    return (
            ...
            <div className="border-t-footerTx border-t-2 lg:pt-14 md:pt-12 sm:pt-11 pt-8 lg:pb-16 md:pb-14
             sm:pb-12 pb-8 w-full flex lg:flex-row sm:flex-col flex-col justify-between gap-2">
                <div className="flex flex-col gap-3">
                    <SmallText tailwind="text-footerTx">{`${(new Date()).getFullYear()} ${profile.name} ${profile.surname}. ${footer.rights}`}</SmallText>
