...
export default function ProgressRounds({ colorRound, tailwind }: { colorRound: string, tailwind?: string }) {
    return (
        <div className={` ${tailwind} absolute z-10 -left-[19.3%] -translate-y-[50%] -translate-x-[50%] top-1/2 h-16 w-16 rounded-full ${colorRound} flex justify-center items-center`}>
