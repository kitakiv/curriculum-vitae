...
//     const {projectTitle, projectDescription, projectImages, projectDemoLink, projectGithubLink} = form.projectForm.initialValues;
...
//             <ListProjects type="add" projects={[{title: projectTitle, description: projectDescription, image: projectImages, githubLink: projectGithubLink, demoLink: projectDemoLink}]} />
