    ...
    return (
        <>
            ...
            <div className="relative w-11 h-11 z-40 lg:hidden sm:block block" onClick={() => setShowItem((prev) => !prev)}>
                ...
                <nav className="fixed top-0 right-0 w-screen h-screen liquid-glass-burger padding transition duration-700" style={{ transform: showItem ? "translateX(0)" : "translateX(100%)" }}>
