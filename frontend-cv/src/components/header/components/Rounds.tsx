export default function Rounds() {
    return (
       <>
        ...
        <div className="absolute lg:w-80 lg:h-80 md:w-64 md:h-64 sm:w-64 sm:h-64 w-48 h-48 bottom-11 right-11 rounded-full bg-gradient-to-tl from-rn100 to-rn0 opacity-40 animation-gradient-animate z-0 overflow-hidden"></div>
       </>
    );
}