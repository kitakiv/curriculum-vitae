...
const ROLES_REMOVE_MUTATION = gql`
...
export {RESOURCES_GET_QUERY, SLIDERS_GET_QUERY, SLIDER_GET_ONE_QUERY, SLIDER_CREATE_MUTATION, ROLES_GET_QUERY, ROLE_GET_ONE_QUERY, ROLE_CREATE_MUTATION, ROLE_REMOVE_MUTATION, ROLE_UPDATE_MUTATION, SLIDER_REMOVE_MUTATION, SLIDER_UPDATE_MUTATION, ROLES_REMOVE_MUTATION};