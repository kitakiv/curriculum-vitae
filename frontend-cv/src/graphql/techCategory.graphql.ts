...
const TECHCATEGORIES_DELETE_MUTATION = gql`
...
export { TECHCATEGORIES_GET_QUERY, TECHCATEGORY_TECHSTACK_QUERY, TECHCATEGORY_CREATE_MUTATION, TECHCATEGORY_DELETE_MUTATION, TECHCATEGORY_UPDATE_MUTATION, TECHCATEGORY_GET_ONE_QUERY, TECHCATEGORIES_DELETE_MUTATION };